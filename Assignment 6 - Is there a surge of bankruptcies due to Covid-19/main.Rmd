...
Based on the results when comparing data from 2019-01-01 to `r format(now_date, "%Y-%m-%d")` no clear conclusion can be taken as there are no significant change. However looking at these numbers alone is not enough to give a final conclusion. This is because some company types are more affected than others such as the musical industry. 

It would thus be neccessary to include other data to be able to take a better conclusion.
