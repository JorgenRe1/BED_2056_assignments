...
Based on the given data there were born r moreBornBoys`% more boys than girls from 2017 to 2019. The numbers were stable and did not fluctuate significantly away from that number.
...
The proportion between boys and girls born does not seem to depend a noticeable amount each yea on which weekday they are born onr. 
